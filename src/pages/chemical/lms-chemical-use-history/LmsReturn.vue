    ...
    <div class="layout-content-padding">
      <div class="layout-content-main">
        <Row>
          ...
          <Form id="search-form3" inline onsubmit="return false" :label-width="70">
  ...
  export default {
    ...
    data() {
      return {
        ...
        pageColumns: [
          {title: '归还单号', key: 'orderGiveId',width: 200, align: 'center', ellipsis: true,sortable:'true',},
          {title: '耗材名称', key: 'chemicalName', align: 'center', ellipsis: true,sortable:'true',},
        //  {title: '领用数量', key: 'applyNum', width: 180, align: 'center', ellipsis: true,sortable:'true',},
          {title: '归还量', key: 'giveQuantity', width: 150, align: 'center', ellipsis: true,sortable:'true',},
         // {title: '剩余量', key: 'subNum', width: 150, align: 'center', ellipsis: true,sortable:'true',},
          {
            title: '归还时间', key: 'ltime', width: 200, align: 'center', ellipsis: true,sortable:'true',
            render: (h, params) => {
    ...
    methods: {
      ...
      _page() {
        this.$store.dispatch('LmsChemicalUseHistory/returnPage', this._searchParams()).then(() => {
          this.loading = false;
      ...
      _searchParams() {
        let data = this.$serialize('search-form3');
