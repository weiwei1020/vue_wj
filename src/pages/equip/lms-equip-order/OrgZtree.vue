<template>
  ...
  <Modal v-model="showTreeModal">
    ...
    <div class="treeHeight">
      ...
      <ul id="orderOrgTree" class="ztree" v-show="isTree"></ul>
    </div>
    ...
    methods: {
      ...
      _getZtree() {
        ...
        this.$store.dispatch('LmsStaffInfo/orgTreeList').then(() => {
          $.fn.zTree.init($("#orderOrgTree"), setting, this.$store.state.LmsStaffInfo.orglist);
          treeObj = $.fn.zTree.getZTreeObj("orderOrgTree");
