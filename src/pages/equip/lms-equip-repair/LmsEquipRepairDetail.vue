<template>
    <div>
        <Modal v-model="showDetailModal" title="仪器维修信息表详情" :width="750">
            <div class="maxHeight">
          ...
          <Row>
            ...
            <Table :columns="pageColumns" :data="obj.lmsEquipRepairDetailVOList" size="small" border highlight-row stripe
                   :height="200"></Table>
            </Col>
          </Row>
        </Modal>
