    ...
    <div class="layout-content-padding">
      <div class="layout-content-main">
        <Row>
          ...
          <Form id="search-form-maintain" inline onsubmit="return false" :label-width="70">
            <label class="label-sign"></label>
            <Form-item class="width-23" label="计划名称:">
              <Input name="maintainName" placeholder="请输入计划名称" @on-enter="_search"/>
            </Form-item>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        pageColumns: [
          ...
          {title: '计划名称', key: 'maintainName', align: 'center', width: 160, fixed: 'left',},
          ...
          {title: '仪器编号', key: 'equipNum', align: 'center', width: 160},
    ...
    methods: {
      ...
      _searchParams() {
        let data = this.$serialize('search-form-maintain');
